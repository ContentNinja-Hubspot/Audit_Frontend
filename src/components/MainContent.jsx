        ...
        {page !== "past" && (
          <>
            <button
              ...
              className="bg-inherit text-black disabled:cursor-not-allowed disabled:opacity-50 text-xs p-0"
              title="Share Report"
            >
              Share <FontAwesomeIcon icon={faShare} className="h-3 w-4" />
            </button>
            ...
            >
              {downloading ? (
                ...
                <>
                  Download{" "}
                  <FontAwesomeIcon icon={faDownload} className="h-3 w-4" />
                </>
              )}
            </button>
          </>
